...
I'm a **.NET Backend Developer** based in Tehran, Iran, passionate about designing and delivering **scalable, distributed, and high-performance systems**.

Over the past 6+ years I've worked across startups and enterprises — writing APIs that handle real load, migrating monoliths to microservices, and obsessing over clean, maintainable code.

- 🔭 &nbsp;Currently focused on **Microservices**, **Clean Architecture**, and **Event-Driven Systems**
- 🌱 &nbsp;Currently learning **Rust** and **Machine Learning with Python**
- ⚡ &nbsp;Fun fact: I once improved a production API's response time by **~35%** just through query profiling and index tuning
- 💬 &nbsp;Ask me about: `.NET` · `Microservices` · `Clean Architecture` · `CQRS` · `DDD` · `Keycloak`
...
|--------|-------------|------|
| [**Base**](https://github.com/MassoudKargar/Base) | Reusable base framework for building clean, layered .NET applications — used as a foundation across multiple projects | C#, .NET, Clean Architecture |
...
| [**PollyNET**](https://github.com/MassoudKargar/PollyNET) | Resilience patterns (retry, circuit breaker, timeout) with Polly and .NET 6 | C#, Polly, .NET 6 |
| [**WebApi**](https://github.com/MassoudKargar/WebApi) | Professional REST API design with ASP.NET Core — versioning, error handling, Swagger | ASP.NET Core, REST |
| [**Architecture**](https://github.com/MassoudKargar/Architecture) | Reference implementation for layered and clean architecture patterns in .NET | C#, Clean Architecture |
